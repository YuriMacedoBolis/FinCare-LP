          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                >
                  {/* Left column */}
                  <div className="flex-none md:flex-1 flex flex-col items-center md:items-start gap-3 md:gap-5 text-center md:text-left max-w-xl px-2 md:px-0">
                    ...
                    <button
                      ...
                      className="mt-1 md:mt-2 md:self-start inline-flex items-center justify-center bg-[#FF6400] hover:bg-[#e55a00] text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-xl text-sm md:text-base shadow-lg shadow-orange-500/30 transition-all duration-300 hover:scale-[1.02]"
                    >
                      Garantir Minha Vaga
                    </button>
                  </div>
